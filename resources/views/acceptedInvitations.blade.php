      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="{{route('accepted',$email)}}" class="nav-link active">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">All Accepted Invitations.</h3>
        </div>
        <div class="card-body">
          <table class="table table-dark">
            ...
            <tbody>
              <tr>
                ...
                <th>{{++$i}}</th>
                <td>{{$invitation->sender_email}}</td>
                <td>{{$invitation->occation}}</td>
